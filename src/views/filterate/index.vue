<template>
  <div class="table-container">
    ...
    <el-table ref="tableSort" v-loading="listLoading" :data="list" :element-loading-text="elementLoadingText"
      ...
      <el-table-column align="left" show-overflow-tooltip prop="updated_at" label="域名" />
   

      <el-table-column align="left" show-overflow-tooltip prop="group_name" label="添加时间" />
