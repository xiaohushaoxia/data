  ...
  >
    <el-form ref="form" :model="form" label-width="80px">
      ...
      <el-form-item label="分组" prop="type">
        ...
        <el-button icon="el-icon-refresh" style="margin-left: 10px" @click="getGroupForSessionList"></el-button>
      </el-form-item>
...
<script>
import {Import} from '@/api/smsLink'
...
export default {
  ...
  methods: {
    ...
    Upload(fileObj) {
      ...
      Import(f).then(res => {
        this.$baseNotify('文件导入成功,任务后台执行中...', '任务执行中',)
        this.form = {}
      }).catch(err => {
